(function (root, factory) {
        ...
        if (data.icons) {
            ...
            (function() {
                ...
                if ("number" == typeof $obj.length) {
                    for (var $index = 0, $l = $obj.length; $index < $l; $index++) {
                        var icon = $obj[$index];
                        buf.push("<a" + jade.attr("href", icon.href, true, false) + jade.attr("title", icon.title, true, false) + jade.cls([ "icon", "icon-" + icon.name + "", icon.modifiers ], [ null, true, true ]) + "></a>");
                    }
                } else {
                    var $l = 0;
                    for (var $index in $obj) {
    ...
    templatizer["error-heading"]["error-heading"] = function tmpl_error_heading_error_heading(data) {
        ...
        if (data.button) {
            buf.push(templatizer["error-heading"]["button"](data.button));
        }
    ...
    templatizer["table-of-contents"]["table-of-contents"] = function tmpl_table_of_contents_table_of_contents(data) {
        var block = this && this.block, attributes = this && this.attributes || {}, buf = [];
        buf.push('<div class="table-of-contents"><ul class="table-of-contents-nav">');
        (function() {
            var $obj = data.nav;
            if ("number" == typeof $obj.length) {
                for (var $index = 0, $l = $obj.length; $index < $l; $index++) {
        ...
        buf.push('</ul><div class="table-of-contents-sections"><ul class="table-of-contents-sections-items">');
        (function() {
            var $obj = data.sections.items;
            if ("number" == typeof $obj.length) {
                for (var $index = 0, $l = $obj.length; $index < $l; $index++) {
                    var item = $obj[$index];
